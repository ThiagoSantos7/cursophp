...
<body>
    ...
    <main>
        ...
        <section>
            <form>
                <?php
                echo "<p>O produto que custava " . numfmt_format_currency($padrao, $preco, "BRL") . " com aumento de <strong>$percentual%</strong> vai passar a custar " . numfmt_format_currency($padrao, $result, "BRL") . " a partir de agora.</p>"
                ?>
            </form>
        </section>
    </main>
